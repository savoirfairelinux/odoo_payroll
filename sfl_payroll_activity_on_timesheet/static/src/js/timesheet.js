openerp.sfl_payroll_activity_on_timesheet = function(instance) {
    ...
    instance.hr_timesheet_sheet.WeeklyTimesheet = instance.hr_timesheet_sheet.WeeklyTimesheet.extend({
        ...
        init_add_account: function() {
            ...
            self.activity_m2o.prependTo(self.$(".oe_timesheet_weekly_add_row td:first-child"));
            self.account_m2o.prependTo(self.$(".oe_timesheet_weekly_add_row td:first-child"));
