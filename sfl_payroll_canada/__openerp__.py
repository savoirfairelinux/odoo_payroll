...

{
    ...
    'depends': [
        ...
        'sfl_payroll_benefit_exemption',
        'sfl_payroll_benefit_on_job',
        'sfl_payroll_benefit_percent',
        'sfl_payroll_public_holidays',
        'sfl_payroll_amount_ytd',
        'sfl_payroll_leave_accrual',
        'sfl_payroll_rule_variable',
