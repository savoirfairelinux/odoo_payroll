...
from openerp.addons.sfl_payroll_quebec.tests.test_hr_releve_1_summary import (
...
class TestHrReleve1SummaryAccount(TestHrReleve1SummaryBase):
    ...
    def setUp_qc_payroll_accounting(self):
        ...
        hsf_rule_id = self.ref('sfl_payroll_quebec.rule_qc_hsf_er_c')
        ...
        self.company_model.write(cr, uid, [self.company_id], {
            'payroll_journal_id': self.ref(
                'sfl_payroll_canada_account.payroll_journal'),
