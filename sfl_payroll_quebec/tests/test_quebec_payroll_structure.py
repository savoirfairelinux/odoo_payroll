...
from openerp.addons.sfl_payroll_canada.tests.test_hr_cra_t4 import (
        ...
        self.employee_id = self.employee_model.create(cr, uid, {
            ...
            'deduction_ids': [
                (0, 0, {
                    ...
                    ('sfl_payroll_canada.rrsp', 15),
                    ('sfl_payroll_quebec.qitf', 16),
                    ('sfl_payroll_quebec.qitj', 17),
                    ('sfl_payroll_quebec.qitj1', 18),
                    ('sfl_payroll_quebec.qitk1', 988),
                    ('sfl_payroll_quebec.qite', 1040),
                    ('sfl_payroll_quebec.qitq', 21),
                    ('sfl_payroll_quebec.qitq1', 22),
                ]
            ]
        }, context=context)
